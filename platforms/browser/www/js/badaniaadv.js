...
function szczegolyPage(clicked_id) {
  firebase.auth().onAuthStateChanged(function (user) {
    ...
    var nazwy2 = ["Bialekrwinki", "Czerwonekrwinki", "Hemoglobina", "Hematokryt", "Limfocyty", "Monocyty", "MCV", "MCH", "MCHC", "Plytkikrwi", "OB", "Glukoza", "Cholesterol", "TSH", "ALAT", "AspAT", "Potas", "Sod", "Magnez", "Wapn", "Zelazo", "WitaminaB12"];
    var twojewartosci = [];
    var rozneodnormy = [];
